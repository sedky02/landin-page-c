...
function Footer(){
    ...
    const checkClassBtn = toggleBtn? "clicked": "";
    const checkClass2 = toggle2? "clicked2": "";
    ...
    function toggleClassBtn(){
        setToggleBtn(true);
        setsuccsess( email.includes('@') || email==""? "" : "Please enter a valid email")
        setTimeout(()=>{
            setToggleBtn(false);
        },400)
    ...
    return(
        <div className="footer">
            <div className="part1">
                ...
                <button style={{fontSize:"1rem",padding:"1rem 3rem " }} className={`getStarted ${checkClass2}`} onClick={toggleClass2}>get started</button>
            </div>
            <div className="part2">
                <div className="logo">
                    <Link to="/">
                ...
                <div className="inbox">
                    <div      className="input">
                        <input type="email" onChange={e=>{setEmail(e.target.value)}} placeholder="Updates in your inbox..."/>
                        <button className={`getStarted ${checkClassBtn}`} onClick={toggleClassBtn}>go</button>
                    </div>
                    <p style={{color: "red"}}>{succsess}</p>
