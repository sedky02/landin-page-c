...
function Nav(){
    ...
    const fade = toggleStyle? "fade-off":"fade-on";
    const colorMe = toggleStyle? "blue":"red";
    return(

        <nav className="nav">
            <Link to="/" style={{margin:".6rem 0 0" }}>
            ...
            <ul className={`nav-links ${fade}` }>
                <Link to="/" style={{textDecoration:"none",color:"black"}}>
                    <li onClick={styleChange}>Home</li>
                </Link>
                <Link to="/pricing" style={{textDecoration:"none",color:"black"}}>
                    <li onClick={styleChange}>Pricing</li>
                </Link>
                <Link to="/product" style={{textDecoration:"none",color:"black"}}>
                    <li onClick={styleChange}>Product</li>
                </Link>
                <Link to="/about" style={{textDecoration:"none",color:"black"}}>
                <li onClick={styleChange}>About US</li>
                </Link>
                <Link to="/pageNotFound" style={{textDecoration:"none",color:"black"}}>
                <li onClick={styleChange}>Careers</li>
                </Link>
                <div className="bg-color"></div>

            </ul>
            <button className={`getStarted ${checkClass}`} onClick={toggleClass}>get started</button>
            <div className={`humberger ${colorMe}`} onClick={styleChange}>
